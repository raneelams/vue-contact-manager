    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col">
                ...
                <p class="fst-italic">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor ipsam incidunt totam doloribus labore voluptatibus nihil delectus fugiat soluta, a est odio quibusdam, provident quidem debitis nesciunt quos facere maiores?</p>
            </div>
        </div>
    </div>
    <div class="container mt-3">
            ...
            <div class="col-md-4">
                <form @submit.prevent="addContact()">
                    <div class="mb-2">
                     ...
                     <div class="mb-2">
                        <select required v-model="contact.groupdId" class="form-control" v-if="groups.length > 0">
...
export default {
    ...
    created : async function() {      //lifecycle hook method
    try {
